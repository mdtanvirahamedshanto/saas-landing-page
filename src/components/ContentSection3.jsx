...
const PaymentInfo = () => {
    return (
        <div className='py-8 md:py-10 xl:py-20 relative'>
            ...
            <div className="container flex flex-col-reverse sm:flex-row gap-4 xl:gap-16 justify-between items-center">
                ...
                <div className='sm:w-5/12'>
                    ...
                    <p className='text-xl py-2 pb-10 sm:py-4 lg:py-6 xl:py-10'>Why kept very ever home mrs. Considered sympathize ten uncommonly occasional assistance sufficient not. Letter of on become he tended active enable to. </p>
